...
def _save_spec(workflow: dict, ui: object) -> dict:
    ...
    from hermes_cli.workflows_api import cli_bridge, config
...
def _overlay_live_telemetry(run: dict) -> dict:
    ...
    try:
        from hermes_cli.workflows_api import config, telemetry
...
async def list_workflows() -> dict:
    ...
    from hermes_cli.workflows_api import config, tools
...
def _next_run_by_workflow() -> dict:
    ...
    try:
        from hermes_cli.workflows_api.bridge import cron as cron_bridge
...
async def export_workflow_template(workflow_id: str) -> dict:
    ...
    from hermes_cli.workflows_api import cli_bridge, template_export
...
async def review_run(
    ...
    from hermes_cli.workflows_api import config, tools
    from hermes_cli.workflows_api.cli import build_engine
...
async def run_workflow(workflow_id: str, payload: dict = Body(default={})) -> dict:
    ...
    from hermes_cli.workflows_api import cli_bridge, config, tools
    from hermes_cli.workflows_api.bridge import cron
    from hermes_cli.workflows_api.cli import (
...
def _run_trace(run_id: str) -> str | None:
    ...
    try:
        from hermes_cli.workflows_api import config
        from hermes_cli.workflows_api import trace as trace_mod
...
async def retry_run(run_id: str, payload: dict = Body(default={})) -> dict:
    ...
    from hermes_cli.workflows_api.bridge import cron
    from hermes_cli.workflows_api.cli import build_engine
    from hermes_cli.workflows_api.engine import ResumeError
...
async def list_profiles() -> dict:
    ...
    from hermes_cli.workflows_api import config as wf_config
